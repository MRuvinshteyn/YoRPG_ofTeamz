...
public class YoRPG
{
	...
	if (azul.isAlive() == true){
		...
		System.out.println( "\n" + pat.getName() + " " + pat.getVerb() + " for " + d1 +
				    " points of damage. The demon now has " + azul.getHealth() + " points of hit!");

		System.out.println( "\n" + "Ye Olde demon smacked " + pat.getName() +
				    " for " + d2 + " points of damage. You now have " + pat.getHealth() + " points of hit!");
	    }//end while
		

	    //option 1: you & the monster perish
	    if ( !azul.isAlive() && !pat.isAlive() ) {
		System.out.println( "'Twas an epic battle, to be sure... " + 
				    "You cut ye olde demon down, but " +
				    "with its dying breath ye olde monster. " +
				    "laid a fatal blow upon thy skull." );
		return false;
	    }
	    //option 2: you slay the beast
	    else if ( !azul.isAlive() ) {
		System.out.println( "HuzzaaH! Ye olde demon hath been slain!" );
		return true;
	    }
